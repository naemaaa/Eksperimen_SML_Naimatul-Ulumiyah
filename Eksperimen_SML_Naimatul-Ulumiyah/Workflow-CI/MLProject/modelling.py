...
modelling.py
============
Basic model training dengan MLflow autolog.
Dataset: Sepsis ICU (PhysioNet 2019)
...
Output:
    - MLflow experiment tersimpan lokal (./mlruns)
    - Buka UI: mlflow ui
"""
...
with mlflow.start_run(run_name='RandomForest_Autolog'):
    ...
    # AUTOLOG — otomatis log semua params, metrics, dan model
